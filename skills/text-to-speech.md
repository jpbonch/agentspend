...
skill_url: "https://raw.githubusercontent.com/agentspend/agentspend/main/skills/text-to-speech.md"
auth_type: "x402"
...
```bash
npx agentspend use https://x402-gateway-production.up.railway.app/api/tts/elevenlabs \
  --method POST \
  --header "content-type:application/json" \
  --body '{"text":"Hello from AgentSpend","voice_id":"21m00Tcm4TlvDq8ikWAM","format":"mp3_44100_128"}' 
```
